import { createError, sendNoContent, assertMethod, readFormData, setHeader, getValidatedRouterParams, getHeader, getValidatedQuery, getRequestWebStream, readValidatedBody, eventHandler } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/h3/dist/index.mjs';
import { ofetch } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/ofetch/dist/node.mjs';
import { joinURL } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/ufo/dist/index.mjs';
import { r as requireNuxtHubFeature } from '../../../_/features.mjs';
import { a as useRuntimeConfig } from '../../../_/nitro.mjs';
import { createStorage } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unstorage/dist/index.mjs';
import httpDriver from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unstorage/drivers/http.mjs';
import cloudflareKVBindingDriver from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unstorage/drivers/cloudflare-kv-binding.mjs';
import mime from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/mime/dist/src/index.js';
import { z } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/zod/index.js';
import { defu } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/defu/dist/defu.mjs';
import { randomUUID } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/uncrypto/dist/crypto.node.mjs';
import { parse } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/pathe/dist/index.mjs';
...
function createCloudflareAPI(accountId, apiToken, basePath = "") {
...
function handleCloudflareError(err, defaultMessage = "Cloudflare API error") {
...
async function createCloudflareR2Credentials(accountId, apiToken, bucketId, options = {}) {
