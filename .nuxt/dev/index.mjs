...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getResponseStatus, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/destr/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file://C:/Users/Eman/Documents/GitHub/worked/.nuxt/nuxt-icon-server-bundle.mjs';
import localAdapter from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/Eman/Documents/GitHub/worked/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/Eman/Documents/GitHub/worked/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Eman/Documents/GitHub/worked","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Eman/Documents/GitHub/worked/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Eman/Documents/GitHub/worked/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Eman/Documents/GitHub/worked/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/Eman/Documents/GitHub/worked/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/Eman/Documents/GitHub/worked/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const _Jt1oLWNpPK5KOQyJHv_V97M9CN96knn2sMLr1m3msbA = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "C:/Users/Eman/Documents/GitHub/worked";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Women wellness & healing blog"}],"link":[],"style":[],"script":[],"noscript":[],"title":"AmnaMandalas"};
...
const _KnUJyMdtAgdJJNJCwvxT4O95oxjUG8uxaOypVGBrD8 = (nitroApp) => {
...
const _y836Kxi8IJ2c5W36heLcBudu_CHZnhoeXSBzX5goAis = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _Jt1oLWNpPK5KOQyJHv_V97M9CN96knn2sMLr1m3msbA,
_KnUJyMdtAgdJJNJCwvxT4O95oxjUG8uxaOypVGBrD8,
_y836Kxi8IJ2c5W36heLcBudu_CHZnhoeXSBzX5goAis
];
...
const _U0SAiN = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/Users/Eman/Documents/GitHub/worked/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/Eman/Documents/GitHub/worked/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _vSrdwr = defineCachedEventHandler(async (event) => {
...
const _vsDjVb = eventHandler(async (event) => {
  ...
  return await import('file://C:/Users/Eman/Documents/GitHub/worked/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _taqPiC = eventHandler(async (event) => {
...
const _SG2hes = lazyEventHandler(() => {
...
const _lazy_nC26pt = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _U0SAiN, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_nC26pt, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _vSrdwr, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _vsDjVb, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _taqPiC, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _SG2hes, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_nC26pt, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nC26pt, lazy: true, middleware: false, method: undefined }
];
